from PyQt6.QtWidgets import (
    ...
    QGroupBox, QLabel, QLineEdit, QPushButton, QScrollArea, QComboBox
)
...
class SoundInsulationUI(QMainWindow):
    def __init__(self):
        ...
        self.material_info_panel.setFixedSize(650, 650)
        ...
        # --- Material Type Selection Panel with Scroll ---
        ...
        self.material_scroll_area.setFixedSize(300, 200)
        material_info_layout.addWidget(self.material_scroll_area)

        # --- Container for Material Dropdowns ---
        self.material_container = QWidget()
        self.material_layout = QVBoxLayout()
        self.material_container.setLayout(self.material_layout)
        self.material_scroll_area.setWidget(self.material_container)
        ...
        self.material_layout.addWidget(label1)
        self.material_layout.addWidget(self.material_dropdown1)
        self.material_layout.addSpacing(10)
        self.material_layout.addWidget(label2)
        self.material_layout.addWidget(self.material_dropdown2)
        self.material_layout.addSpacing(10)
        self.material_layout.addWidget(label3)
        self.material_layout.addWidget(self.material_dropdown3)

        # --- Material Input Panel ---
        self.material_input_panel = QGroupBox("Material Input Panel")
        self.material_input_panel.setFixedSize(600, 400)
        material_input_layout = QVBoxLayout()
        self.material_input_panel.setLayout(material_input_layout)
        material_info_layout.addWidget(self.material_input_panel)
        ...
        self.calculation_panel.setFixedSize(400, 650)
